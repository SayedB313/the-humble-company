...
import { Check, Menu, DollarSign, Target, BarChart2, Users, Network, PieChart, TrendingUp } from "lucide-react";
...
export default function EquityInvestment() {
  ...
  const services = [
    {
      ...
      description: "Strategic equity investments in high-potential companies.",
      benefits: [
        "Growth capital",
    ...
    },
    {
      ...
      description: "Active partnership to drive business growth and value.",
      benefits: [
        "Strategic guidance",
    ...
    },
    {
      ...
      description: "Comprehensive support for portfolio companies.",
      benefits: [
        "Network access",
  ...
  const process = [
    {
      title: "Deal Sourcing",
      description: "Identifying high-potential investment opportunities"
    },
    {
      title: "Due Diligence",
      description: "Comprehensive evaluation of investment targets"
    },
    {
      title: "Investment Structure",
      description: "Optimal deal structuring and terms"
    },
    {
      title: "Value Creation",
      description: "Active partnership and growth support"
    },
    {
      title: "Exit Planning",
      description: "Strategic planning for optimal returns"
    }
  ];
      ...
      <header className="sticky top-0 z-50 bg-gray-900 border-b border-gray-800">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <nav className="hidden md:flex space-x-8">
            ...
            <Link href="/services/equity-investment" className="text-white transition-colors">
              Equity Investment
            </Link>
          </nav>
        </div>
      ...
      <main className="flex-grow">
        ...
        <section className="py-20 px-4">
          <div className="container mx-auto text-center">
            ...
            >
              Strategic capital and partnership for ambitious companies
            </motion.p>
            <motion.button
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
        ...
        <section className="py-16 px-4">
          <div className="container mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
              Schedule a consultation to discuss your growth objectives and explore partnership opportunities.
            </p>
